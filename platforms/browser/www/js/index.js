...
function getAll() {
  ...
  request.open("GET", "https://192.168.1.4:45455/api/products", true);
...
function deleteProduct(id) {
  var request = new XMLHttpRequest();
  request.open("DELETE", "https://192.168.1.4:45455/api/products/" + id, true);
  request.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
...
function updateProduct(product) {
  ...
  request.open("PUT", "https://192.168.1.4:45455/api/products/" + product.id, true);
...
function createProduct(product) {
  ...
  request.open("POST", "https://192.168.1.4:45455/api/products", true);
